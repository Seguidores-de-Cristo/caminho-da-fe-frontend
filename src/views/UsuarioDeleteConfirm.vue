<template>
  <div class="max-w-md bg-white p-6 rounded shadow">
    ...
    <div v-else class="space-y-4">
      <div>Deseja realmente excluir o discipulador <strong>{{ item.nome }}</strong> (ID: {{ item.id }})?</div>
      ...
      <div class="flex justify-end gap-2">
        ...
        <button @click="confirm" :disabled="submitting" class="px-4 py-2 bg-red-600 text-white rounded disabled:opacity-50">
          <span v-if="submitting">Excluindo...</span>
